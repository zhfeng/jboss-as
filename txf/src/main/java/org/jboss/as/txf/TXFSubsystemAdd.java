...
import org.jboss.as.txf.dup.TXFrameworkDeploymentActivator;
 ...
 */
class TXFSubsystemAdd extends AbstractBoottimeAddStepHandler {

    static final TXFSubsystemAdd INSTANCE = new TXFSubsystemAdd();


    private TXFSubsystemAdd() {
    }
