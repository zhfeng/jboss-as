...
public class TransactionCDIProcessor implements DeploymentUnitProcessor {
    ...
    public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        for (ResourceRoot root : DeploymentUtils.allResourceRoots(unit)) {
            ...
            final List<AnnotationInstance> transactionalAnnotations = index.getAnnotations(DotName.createSimple(Transactional.class.getName()));
            final List<AnnotationInstance> transactionScopedAnnotations = index.getAnnotations(DotName.createSimple(TransactionScoped.class.getName()));
